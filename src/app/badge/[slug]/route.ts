...
function svg(label: string, score: string, color: string): string {
  ...
  <text x="12" y="17" font-family="ui-sans-serif,system-ui,sans-serif" font-size="9" fill="#8d9bad" letter-spacing="0.8">AGENT-READY SCORE</text>
  <text x="12" y="32" font-family="ui-sans-serif,system-ui,sans-serif" font-size="13" fill="#e8edf4">${escapeXml(label)}</text>
